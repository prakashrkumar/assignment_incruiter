...
const ResetPassword = () => {
  ...
  const[isOtpSubmited,setIsOtpSubmited]=useState(false)
    ...
    const onSubmitNewPassword=async(e)=>{
      e.preventDefault();
      try{
        const {data}=await axios.post(backendUrl + '/api/auth/reset-password',{email,opt,newPassword})
        data.success ?toast.success(data.message):toast.error(data.message)
  ...
  return (
    ...
    <button className='w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-900'>Submit</button>
