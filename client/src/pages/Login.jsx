    ...
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
        ...
        <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
          ...
          {state==='Sign Up' ? 'create Account':'Login'}</h2>
           ...
           {state==='Sign Up' && (<div className='mb-4 flex items-center gap-3 w-full px-4 py-2.5 rounded-full bg-[#333A5C]'>
             <img src={assets.mail_icon} alt='' />
           <input onChange={e=>setNmae(e.target.value)} value={name}  className='bg-transparent outline-none' type='text' placeholder='Full Name' required/>
            </div>)}
           ...
           </p>): (<p className='text-gray-400 text-center text-xs mt-4'>Do not have an account? {' '}
